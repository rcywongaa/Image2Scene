...
nnoremap  k
nnoremap  zll
nnoremap  r :%s/\s\+$//e:%s/[^[:alnum:][:punct:][:space:]]//gce:%s/\t/    /gemzgg=G`z:retab
nnoremap  = mzgg=G`z:retab
nnoremap    :mapclear:source $MYVIMRC
nnoremap  l :tabm +1
nnoremap  h :tabm -1
...
nnoremap ZZ <Nop>
nnoremap x "_x
map <F4> :!rm session.vim
map <F3> :source session.vim
...
set shortmess=aoO
badd +0 segmentImage.m
badd +0 optimizeColor.m
badd +0 getCorrelation.m
args segmentImage.m
edit segmentImage.m
...
silent! normal! zE
let s:l = 79 - ((45 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
normal! 016|
tabedit getCorrelation.m
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
